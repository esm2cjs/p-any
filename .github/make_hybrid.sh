...
sed -i 's#p-cancelable#@esm2cjs/p-cancelable#' test.mjs
...
replace_imports "p-some" # to = "@esm2cjs/FROM"
replace_imports "p-cancelable" # to = "@esm2cjs/FROM"
...
PJSON=$(cat package.json | jq --tab '
	...
	| .dependencies["@esm2cjs/p-some"] = .dependencies["p-some"]
	| del(.dependencies["p-some"])
